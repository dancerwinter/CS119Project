...
@EActivity(R.layout.activity_class_photo_crop)
public class ClassPhotoCrop extends AppCompatActivity {
    ...
    public void cropImage() {
        ...
        if (cropped != null) {
            ...
            // converts the byte[] to a jpeg format
            ...
            Intent p = getIntent();
            // class String name
            String subjectName = p.getStringExtra("imgName");
